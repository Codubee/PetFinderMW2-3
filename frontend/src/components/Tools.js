        ...
        <div>
            ...
            <Col sm="1">
                <Card>
                    ...
                    <img src={reactLogo} alt="Card image cap" class="center"/>
                </Card>
            </Col>
            <Col sm="1">
                <Card>
                    ...
                    <img src={nodeLogo} alt="Card image cap" class="center"/>
                </Card>
            </Col>
            <Col sm="1">
                <Card>
                    ...
                    <img src={jiraLogo} alt="Card image cap" class="center"/>
                </Card>
            </Col>
            <Col sm="1">
                <Card>
                    ...
                    <img src={postmanLogo} alt="Card image cap" class="center"/>
                </Card>
            </Col>
            <Col sm="1">
                <Card>
                    ...
                    <img src={awsLogo} alt="Card image cap" class="center"/>
                </Card>
            </Col>
            <Col sm="1">
                <Card>
